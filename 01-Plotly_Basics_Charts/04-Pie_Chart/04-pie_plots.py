...
def basic_pie_chart():
    """Create a basic interactive pie chart with hover data."""
...
print("Generating Basic Pie Chart...")
basic_pie_chart().show()
# %%

# Example 2: Custom Donut Chart
def custom_donut_chart():
    """Create a customized donut chart with pulled segments."""
    df = generate_market_data()
...
# %%
print("\nGenerating Comparative Pie Charts...")
